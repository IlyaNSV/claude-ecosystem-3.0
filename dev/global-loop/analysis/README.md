...
| **[M16_PREREG.md](M16_PREREG.md)** | **План каузальной пробы «канон vs голый Claude»** — дизайн, 3 кандидата точки старта с коммитами, метрики, ослепление, уборка. Ждёт «го» владельца |
