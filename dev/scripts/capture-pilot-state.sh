...
# (см. dev/_archive/phase-6/PHASE_6_SMOKE_TEST_PLAN.md S7 «/ecosystem:update compatibility post 1.4.0»).
#
# Use cases:
...
echo "  6. diff old new — verify invariants (см. dev/_archive/phase-6/PHASE_6_SMOKE_TEST_PLAN.md S7 pass criteria):"
