...
| **S5** | **Build P3 + P5** (per OD10): P3 `batch-features-to-cc-sdd` + нативный P5 `feature-to-tdd-impl` (снять `disable-model-invocation`, OD9). Сначала D7 phase-kickoff. | follow-up #4 | ⬜ pending (next) | — |
