# ROADMAP — архив развёрнутых блоков фаз 0–7

> Дословный архив: per-phase блоки (Deliverables / Acceptance criteria / Estimated effort / Risks / Lessons),
> PILOT POINT, Estimated total remaining, Dependencies graph. Живой роадмап — корневой
> [`ROADMAP.md`](../../../ROADMAP.md) (секция «Где мы сейчас» — SSOT статуса). Ротация 2026-07-11 (DEC-DEV-0185).
