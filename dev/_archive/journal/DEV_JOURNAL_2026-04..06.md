# DEV_JOURNAL — архив записей DEC-DEV-0001–0123 (2026-04-17 .. 2026-06-30)

> Дословный архив ранних записей журнала разработки Ecosystem 3.0 (включая Backfill-секцию).
> Живой журнал (записи с DEC-DEV-0124, 2026-07+) — корневой [`DEV_JOURNAL.md`](../../../DEV_JOURNAL.md).
> Ротация выполнена 2026-07-11 (deadweight-sweep, DEC-DEV-0185); правило ротации — CONVENTIONS §5.1.
