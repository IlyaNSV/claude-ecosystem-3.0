...
> **Связано:** [DEV_JOURNAL DEC-DEV-0062](../../../DEV_JOURNAL.md), [PHASE_6_SMOKE_TEST_PLAN.md](../../gates/PHASE_6_SMOKE_TEST_PLAN.md) (указывает сюда).
...
- [PHASE_6_SMOKE_TEST_PLAN.md](../../gates/PHASE_6_SMOKE_TEST_PLAN.md) — указывает сюда (S-LE вынесен в отдельный файл во избежание дублирования).
