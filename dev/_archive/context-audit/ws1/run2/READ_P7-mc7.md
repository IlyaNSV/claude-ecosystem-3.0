...
> **▶ Апдейт D13 (2026-07-13, DEC-DEV-0197).** Цитируемая сводка «11 PASS / 2 PARTIAL» **сама оказалась
> ложной** — судья верно выставил 22 per-сценарных вердикта, но ошибся в собственной агрегации; истина —
> **`14 PASS / 3 PARTIAL / 5 N/A / 0 FAIL`**. Т.е. здесь судья себя **занизил**, а не завысил. Цитата
> оставлена как улика (что стояло в документах). Тезис об инфляции LLM-судьи этим **не опровергнут и не
> подтверждён**: пересуда per-сценарных вердиктов не было. SSOT: `dev/gates/SMOKE_BATCH_2026-07-11_BRIEF.md` §Outcome.
