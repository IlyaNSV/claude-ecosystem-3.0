...
> ⚠ **Статусы G01–G36 ниже — снапшот на момент аудита.** Живая сверка «что закрыто /
> что осталось / куда роутится» — [GAPS-RECONCILIATION-2026-07-10.md](GAPS-RECONCILIATION-2026-07-10.md)
> (DEC-DEV-0167). Этот документ as-is не редактируется (конвенция AUDIT §7).
