...
> 📦 **Архивирован 2026-07-28** из `dev/deferred/` (гигиена репо): исполненный work-order,
> лежащий в каталоге «отложенного», ломал семантику каталога — и в него же откладывалось
> обязательство из `dev/meta-improvement/SPEC.md` («глубокая разморозка SPEC»), то есть
> висело в закрытом контейнере. Обязательство закрыто явно — см. caveat в `SPEC.md`.
