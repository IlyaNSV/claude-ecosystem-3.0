...
> **Mechanisms (v1.0):** [`CONVENTIONS.md`](CONVENTIONS.md) §1-§10 + [`checklists/phase-{kickoff,closure}.md`](checklists/) + [`patterns/`](patterns/) (8) + [`skills/memory-sync.md`](skills/memory-sync.md) + [`scripts/verify-update.sh`](scripts/verify-update.sh) + [`hooks/phase-closure-reminder.js`](hooks/phase-closure-reminder.js).
