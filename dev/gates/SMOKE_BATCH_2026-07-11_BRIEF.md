...
>
> **Отдельно:** гипотеза K9 («opus-судья мог ЗАВЫСИТЬ вердикты», `dev/_archive/context-audit/ws1/run2/RULES.md` — ротирован D9) этой правкой **не проверялась и не закрыта** — D13 чинил арифметику агрегации, а не качество суждения. Фактически судья здесь себя **занизил**, а не завысил.
