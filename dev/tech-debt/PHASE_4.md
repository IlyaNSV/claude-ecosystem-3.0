...
Re-run только S12 с seed-фикстурами, без полного S1–S13 цикла. До подтверждения фикса S12 должен считаться открытым в [`dev/PHASE_5_READINESS.md`](../PHASE_5_READINESS.md) Section B.
...
- **10 NOT-COVERED сценариев** (S1, S3, S5–S11, S13) — не покрыты ни одной из 8 audited сессий. Согласно DEC-DEV-0038, полный re-run S1–S13 не требуется; обязательны только S1/S7/S8/S9/S12 (см. [`dev/PHASE_5_READINESS.md`](../PHASE_5_READINESS.md) Section B).
