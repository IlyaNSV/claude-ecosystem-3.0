...
- Знанием всех 24 типов артефактов и их взаимосвязей
...
│   24 типа со schema, rules, relationships, lifecycle        │
├─────────────────────────────────────────────────────────────┤
...
|---|---|---|
| `.product/**/*.md` | Все артефакты (24 типа; `.product/lessons/` + root `app-map.md` покрыты wildcard) | ✓ tracked |
