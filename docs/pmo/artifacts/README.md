...
| **Orchestrator** | Валидирует состояние `.product/` при маршрутизации |
...
Детальные правила V-01..V-17 — в [`pmo/validation.md`](../validation.md).
...
Алгоритм детализируется в [`pmo/processes.md`](../processes.md) + skill [`bg-extraction.md`](../../../skills/product/bg-extraction.md).
...
| Правила валидации | [`pmo/validation.md`](../validation.md) |
| Процессы создания | [`pmo/processes.md`](../processes.md) |
| Как создать артефакт (методология) | [`skills/product/`](../../../skills/product/) |
| Handoff-формат | [`product-module/handoff-spec.md`](../../product-module/handoff-spec.md) |
