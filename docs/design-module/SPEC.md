...
1. **Внешний design tool** (Stitch / Claude Design / Figma / Penpot / HTML):
   - Визуальные макеты
...
|---|---|---|
| **Slash-commands** | 6 команд (`/design:*`) | `.claude/commands/design/` |
| **Skills** | 6 methodology files (`stitch-workflow`, `claude-design-workflow`, ...) | `.claude/skills/design/` |
...
```yaml
version: 1.1
default_design_tool: stitch               # stitch | claude-design | figma | penpot | html
