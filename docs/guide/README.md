...
- 🗺️ **[ecosystem-map.html](ecosystem-map.html)** — *что существует*: пайплайн D1–D6, все команды («когда что»; точное число не дублируем — генерируемый каталог [`02-commands.md`](02-commands.md) не дрейфует), 24 артефакта, глоссарий, фильтр «что работает сегодня».
