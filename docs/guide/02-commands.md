...
| `/product:init` | Start P1.A Discovery Session for a new product. Creates PS, MR, CA, SEG, VP, HYP artifacts. | `<idea description> OR --continue OR --deep OR --pivot OR --from-validated <package-path>` |
