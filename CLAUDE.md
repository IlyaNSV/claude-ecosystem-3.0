...
- `dev/deferred/D7_DEADWEIGHT_CLEANUP.md` — 🅀 QUEUED maintenance work-order: прунинг D7 до работающего+используемого. Sequencing-триггер: D7 process-hardening (DEC-DEV-0082) смёржен в `main`
...
> **принуждаются** блокирующим `commit-msg` gate (`process-gate.js`, DEC-DEV-0082) — обойти
...
| добавил/убрал команду / скилл / хук | обновить `commands/ecosystem/verify.md` (Step 4 + summary) + проверить обзорные шаблоны (`status.md`, `docs/MAP.md`) | cross-component awareness, DEC-DEV-0081 |
...
### 6. Backwards compatibility — узко, не «не важна» (ревизия DEC-DEV-0082)
