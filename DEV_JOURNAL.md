...
35. **Знание правила в контексте ≠ его исполнение — передавай структуру принуждения, а не пересказ.** S2 сформулировала для преемника все правила, которые нарушила сама. Шов/бриф, который «рассказывает как надо», даёт те же 60–68%, что любая проза; работают ACK-чеклист, явные мандаты, гейты. Симметрично для агентских брифов: контракт + anti-patterns + обязанность вернуть расхождения.
36. **Шов, несущий только статус, теряет самое дорогое — инварианты, запреты среды и режим работы.** Кейс entry-63: ограничение «только на VM» жило в диалоге и умерло на границе сессий, после чего S2 ратифицировала самореферентную мутацию. В шаблоне v2 у этих трёх вещей теперь свои обязательные секции, и стоп-блок ре-инжектится хуком после компактации (push бьёт pull).
37. **«Изучи весь релевантный материал» — неоперационализируемая инструкция; критерий достаточности обязан быть satisficing-чеклистом с проверкой усвоения.** Строгий критерий полноты добора доказуемо невычислим (VoI NP^PP; ценность контрфактуальна — узнаётся абляцией), поэтому единственная честная форма — «прочти вот это, затем ответь на вот эти вопросы, потом правь». S2 прочла 5–7% корпуса и объявила себя готовой — ACK бы это поймал за минуту.
