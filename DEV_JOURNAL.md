...
## DEC-DEV-0134 — P2 consilium: два изъяна механизма из профилинг-исследования починены — сырой источник архитекторам (Слой 2) + soft-veto/интеграционный проход (Слой 3)
