...
### Addendum 9 — D11+D12: правила приведены к форме «триггер + scope»; Row 5 механизирован (warn-only, precision измерена)
...
### Addendum 10 — D6: побочный улов заведён в долг (DEF-CTX-1..4), а не забыт в отчёте
